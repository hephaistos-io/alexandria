import type { AttributionFilter, AttributionSort } from "../../types/attribution";
...
const FILTER_OPTIONS: { value: AttributionFilter; label: string }[] = [
  { value: "all", label: "ALL" },
  ...
  return (
    <section className="flex flex-col md:flex-row justify-between items-end gap-4">
      ...
      <div className="flex items-center gap-3 font-mono text-[10px] text-outline">
        ...
        <select
          value={sortBy}
          onChange={(e) => setSortBy(e.target.value as AttributionSort)}
