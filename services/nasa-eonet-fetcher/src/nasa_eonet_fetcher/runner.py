...
class SmartFetchLoop:
    def __init__(
        ...
        on_event: Callable[[NaturalDisaster], None],
    ...
    def _dedup_key(self, event: NaturalDisaster) -> str:
