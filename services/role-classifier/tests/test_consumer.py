...
from role_classifier.consumer import MAX_RECONNECT_ATTEMPTS, MessageConsumer


@patch("role_classifier.consumer.pika.BlockingConnection")
class TestMessageConsumer:
    def test_declares_durable_queue(self, mock_conn_cls: MagicMock) -> None:
        ...
        mock_channel.queue_declare.assert_called_once_with(
            queue="articles.resolved", durable=True
        )
...
@patch("role_classifier.consumer.time.sleep")
@patch("role_classifier.consumer.pika.BlockingConnection")
class TestReconnect:
