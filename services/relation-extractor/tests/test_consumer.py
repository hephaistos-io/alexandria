...
from relation_extractor.consumer import (
    MAX_RECONNECT_ATTEMPTS,
    MessageConsumer,
)


@patch("relation_extractor.consumer.pika.BlockingConnection")
class TestMessageConsumer:
    def test_declares_durable_queue(self, mock_conn_cls: MagicMock) -> None:
        ...
        mock_channel.queue_declare.assert_called_once_with(
            queue="articles.classified.relation", durable=True
        )
    ...
    def test_handle_delivery_reraises_stream_lost_error(
        ...
        # ACK should NOT have been called since connection is dead.
        mock_channel.basic_ack.assert_not_called()


@patch("relation_extractor.consumer.time.sleep")
@patch("relation_extractor.consumer.pika.BlockingConnection")
class TestReconnect:
